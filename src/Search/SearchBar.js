...
class SearchBar extends React.Component {
	 ...
	 * @property {Promise} onTyping - waiting for the books to be fetched when the user types in the search bar
	 */
	async = {
		onTyping: null
	};
	 ...
	 * @name search
	 * @description
	 * Promise executor that performs a search to find books matching the query string typed by the user.
	...
	fetchBooks(query) {
		...
		return new Promise((resolve, reject) => {
				...
				console.error('ERROR: ', error); // NOTE: this is intentional
				const books = [];
